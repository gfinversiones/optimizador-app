...
======================================================
Combina los modelos CAUCETE, CÓRDOBA NORTE, EJE RN Nº 22 y COMODORO – RADA – TILLI en un único script.
...
with st.sidebar:
    ...
    proyecto = st.selectbox(
        ...
        options=["CAUCETE", "CÓRDOBA NORTE", "EJE RN Nº 22", "COMODORO – RADA – TILLI"],
        index=0,
