...
# ── MAIN ──
st.markdown(
    "<p style='font-size:1.1rem; color:#1a56db; font-weight:600; margin-bottom:0;'>🌐 www.gfinversiones.com</p>",
    unsafe_allow_html=True,
)
...
tab_fe, tab_comp, tab_metricas, tab_corr = st.tabs(["📊 Frontera Eficiente", "🏦 Composición", "📐 Indicadores", "🔗 Correlación"])
